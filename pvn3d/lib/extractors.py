...
def resnet18(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet18'], model_dir=config.resnet_ptr_mdl_p
            )
        )
    return model
...
def resnet34(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet34'], model_dir=config.resnet_ptr_mdl_p
            )
        )
    return model
...
def resnet50(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet50'], model_dir=config.resnet_ptr_mdl_p
            )
        )
    return model
...
def resnet101(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet101'], model_dir=config.resnet_ptr_mdl_p
            )
        )
    return model
